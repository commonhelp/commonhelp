 ...
 */
class Request implements \ArrayAccess, \Countable, RequestInterface {
	...
	public function passesCSRFCheck() {
		...
		if(StringUtils::equals($deobfuscatedToken, $this->items['requesttoken'])) {
			return true;
		} else {
			return false;
		}
	...
	private function getOverwriteHost() {
		if($this->config->getOverwritehost('') !== '' && $this->isOverwriteCondition()) {
